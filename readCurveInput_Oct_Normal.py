...
farbGruppe = [['blue', 'darkblue','darkslateblue','royalblue', 'steelblue','darkcyan'],
			...
			['slategray', 'dimgrey']]
farben  = ['blue'] + ['gray']*5
farben+=  ['green' ,'red']  +farbGruppe[0] 
farben2 = farbGruppe[1]+ ['gray']*10
cLineStyle = ['dashed'] + ['solid']*40
#cLabel = ['Ref. EJ200-1X-3',r'23$^\circ$C',r'-30$^\circ$C']
## Parameters 
basename = sys.argv[1] #'EJ260PVT-1X1P-N'
keyword =  basename #+'9'			# read sample
keyword2 = 'xxx'			# read sample
refkeyword = keyword #basename+'1'				# reference sample
...
def save():
	fig.savefig('plots/SpecComp'+keyword+'.png')
